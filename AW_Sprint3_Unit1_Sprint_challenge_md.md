...
# 1. I think coding can become a personalized exercise whereby the coder subconsciously
#    creates a bubble in the code writing style, logic, structure, and organization that
#    he/she develops at that moment or through his/her experience over time. However since 
#    the code may need to be used and read by other teammates, managers, users, and testers,
#    it's important to make sure other people can understand the code under some common
#    style and structure. Code reviews are important to help a coder receive comments and
#    a new perspective that may be outside his/her purview. Code reviews can help a coder
#    improve the readability, useability, and reproducibility of the code. Reviewers may 
#    also help identify any mistakes and issues with the code or maybe a more efficient
#    way to approach the solution. It's an important preliminary quality and assurance 
#    process for collaboration and eventually the productization of the application being
#    coded.
#    In code review, I expect and pay attention first to the comments and docstrings so I can
#    try to get on the same page as the coder as he/she logically builds his/her code at 
#    each step. It's important for me to try and get into the mindset of the coder's 
#    approach to what he/she is building. Next I would review to see if the execution of 
#    code ties together with the noted steps being outlined and documented. This helps
#    break down the code in modular form that helps identify potential missteps. Lastly
#    I would generally defer to the coder's style and process if it is clear and effective
#    but if I see that it can be much more efficient or productive with a different 
#    approach or different choice of code then I would raise it as a discussion point for
#    his/her consideration or reference. 

#    2. With a lot of computers and different things running on each of them, it can
#    negatively effect the reproducibility of the code and applications. As a big corporation
#    Acme has different teams of software engineers and other business departments like 
#    product, finance, and marketing that may need to use the information or application.
#    Containers can increase the portability of the company's system of information while
#    carrying less overhead. Compared to virtual machines, it requires less system resources
#    since it does not contain operating system images. A container can still provide a lot 
#    of the functionality needed with the necessary binary code, executables, libraries and
#    configuration files. ACME DevOps team will find that the containers can provide more
#    consistent operation that runs the same regardless of where the many computers are
#    located. There may also be improvements in efficiency where applications can be more
#    quickly scaled, patched or deployed which helps in agile development and production
#    cycles.
